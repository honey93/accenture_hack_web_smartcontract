  ...
  <div class="top_top">
    ...
    <div class="container-fluid header_top">
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          <h3 class="text-center"> <img src="~/assets/nebulas.png" width="50px"><span v-if="$store.state.language.english">Decentralized Petition System </span>
        ...
        <div class="col-md-3 text-center acount">
          <b-dropdown id="ddown1" :text="account" class="m-md-2">
            ...
            <nuxt-link to="/mystory">
              <span v-if="$store.state.language.english">My Petition: </span> <span v-if="$store.state.language.chinese">我的故事： </span>
      ...
      <ul class="nav justify-content-center">
        <li class="nav-item">
          <nuxt-link to="/"><span v-if="$store.state.language.english">All Petitions </span> <span v-if="$store.state.language.chinese">所有故事 </span> </nuxt-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <nuxt-link to="/mystory">
            <span v-if="$store.state.language.english">My Petitions </span>
            <span v-if="$store.state.language.chinese">我的故事 </span>
          </nuxt-link>
        </li>
        <li class="nav-item">
          <nuxt-link to="/create"><span v-if="$store.state.language.english">Create Petition </span>
    ...
    <b-modal ref="award" hide-footer title="NAS Rewards Program">
      <div class="d-block text-center">
        <h3>Highest Voted Petition will get reward of 10 NAS.
     ...
     <b-modal v-model="$store.state.add_line_flag.status">
      
      {{$store.state.add_line_flag.message}}
    </b-modal>
...
<script>
  ...
  export default {
    ...
    computed:{
      status_flag(){
        return this.$store.state.add_line_flag.status
      }
    }
  };
</script>
